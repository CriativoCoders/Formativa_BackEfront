...
from  app.serializers import ProfessorGestorSerializer, LoginSerializer, DisciplinaSerializer, AmbienteSerializer, SalaSerializer
...
class ProfessorGestorRetriveUpdateDestroyAPIView(RetrieveUpdateDestroyAPIView):
    ...
    serializer_class = ProfessorGestorSerializer
    permission_classes = [IsGestor]
    lookup_field = 'Numero_indentificacao'
